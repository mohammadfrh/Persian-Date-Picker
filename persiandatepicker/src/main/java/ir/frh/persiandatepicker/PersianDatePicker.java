...
import ir.frh.persiandatepicker.util.PersianCalendarConstants;
import ir.frh.persiandatepicker.util.PersianCalendarUtils;
import ir.frh.persiandatepicker.util.PersianHelper;
import ir.frh.persiandatepicker.view.PersianNumberPicker;
...
class PersianDatePicker extends LinearLayout {
    ...
    private void updateViewData() {
        ...
        setDividerColor(yearNumberPicker, Color.parseColor("#CFCECE"));
        setDividerColor(monthNumberPicker, Color.parseColor("#CFCECE"));
        setDividerColor(dayNumberPicker, Color.parseColor("#CFCECE"));
